...
api_router.include_router(endpoints.applicant.router, prefix="/applicants", tags=["applicants"])
...
api_router.include_router(endpoints.jobs.router, prefix="/jobs", tags=["jobs"])
