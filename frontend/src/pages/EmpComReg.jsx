          ...
          <div className="flex items-center w-[850px] -mt-4">
            ...
            >
              <input
                ...
                required
              />
              <span className="w-5 h-5 mr-3 rounded-full border-2 border-[#6B7280] flex items-center justify-center transition-colors duration-200 peer-checked:bg-[#FF8032] peer-checked:border-[#FF8032]">
                {agreed && (
                  <svg
              ...
              <a
                href="/termslink"
                className="text-[#FF8032] ml-1 hover:underline"
                target="_blank"
