  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#FEFEFF] font-montserrat pt-32 pb-20 px-4 sm:pt-44 sm:pb-32 sm:px-12 md:pt-[180px] md:pb-[120px] md:px-[240px]">
      ...
      <div className="w-full flex flex-col items-center mt-10 px-2 sm:px-4">
        <h1 className="text-xl sm:text-3xl md:text-4xl font-bold text-[#E66F24] mb-8 md:mb-12 text-center">
        ...
        <form className="flex flex-col gap-4 sm:gap-6 items-center w-full">
          <div className="w-full max-w-xl">
            ...
            <input
              type="email"
              id="email"
              className="w-full h-12 sm:h-16 md:h-[45px] px-4 sm:px-6 border border-[#6B7280] hover:border-2 bg-[#F9F9F9] rounded-xl md:rounded-2xl text-xs sm:text-sm md:text-base focus:outline-none focus:ring-2 md:focus:ring-4 focus:ring-orange-200"
              value={email}
