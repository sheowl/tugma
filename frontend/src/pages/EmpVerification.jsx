  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#FEFEFF] font-montserrat pt-[180px] pb-[120px] px-[240px]">
      ...
      <div className="w-full flex flex-col items-center mt-10 px-4">
        <h1 className="text-6xl font-bold text-[#E66F24] mb-4 text-center">
        ...
        <form className="flex flex-col gap-8 items-center">
          <div className="flex gap-4 justify-center">
            {[0, 1, 2, 3].map((idx) => (
              <input
                ...
                inputMode="numeric"
                maxLength={1}
                className="w-[106px] h-[140px] text-5xl text-center border-4 border-[#6B7280] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E66F24] bg-[#F9F9F9] mx-1"
                value={code[idx]}
                onChange={(e) => {
          ...
          <p className="text-center text-xl text-[#6B7280] mt-2">
            ...
            <a
              ...
              className="text-[#FF8032] font-semibold hover:underline"
            >
              Resend
            </a>
          </p>
          ...
          <button
            ...
            className="bg-[#FF8032] text-white text-2xl rounded-lg font-bold hover:bg-[#E66F24] transition w-[320px] h-[56px]"
          >
            Confirm Email
          </button>
        </form>
