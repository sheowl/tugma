          ...
          <div className="flex gap-2 sm:gap-3 justify-center">
            {[0, 1, 2, 3].map((idx) => (
              <input
                ...
                inputMode="numeric"
                maxLength={1}
                className="w-12 h-16 sm:w-16 sm:h-20 md:w-20 md:h-24 text-2xl sm:text-3xl md:text-4xl text-center border border-[#6B7280] hover:border-2 font-bold rounded-xl focus:outline-none focus:ring-2 md:focus:ring-4 focus:ring-orange-200 bg-[#F9F9F9] mx-1"
                value={code[idx]}
                onChange={(e) => {
